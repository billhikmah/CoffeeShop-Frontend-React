            ...
            <main className="main-product-details">
                ...
                <div className="container-product-details">
                    <div className="container-1">
                        <div>
                            <img src={this.state.picture} alt="food-pic" className="product-details-pic"/>
                        </div>
                ...
                {this.state.sizeChosen  ?
                    <section className="box-items">
                        <div className="box-items-details">
                            <div className="box-items-details-pic"><img src={this.state.picture} alt="food-pic" className="items-pic"/></div>
